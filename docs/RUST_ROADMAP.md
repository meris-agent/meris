...
- [x] 发布预编译 `meris-rs` CI artifacts（`workflow_dispatch` + `scripts/install_meris_rs_from_ci.ps1`；正式 GitHub Release 页待 tag）
...
- [x] **M5** — system-prompt 桥 + `meris-rs run` 原生入口（见 [PLAN_P5_4.md](PLAN_P5_4.md)）
